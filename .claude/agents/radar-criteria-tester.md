...
ls ~/.gemini/antigravity/projects/smart-volume-radar/results/scan-*.json | sort | tail -90

# Lean Radar snapshots (if testing Lean changes)
ls ~/.gemini/antigravity/projects/smart-volume-radar/results/lean-*.json | sort | tail -90
...
cat ~/.gemini/antigravity/projects/smart-volume-radar/results/monitor-list.json
```
