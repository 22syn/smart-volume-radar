...
All paths below are relative to the repo root: `~/.gemini/antigravity/projects/smart-volume-radar`.
...
Run: `cd ~/.gemini/antigravity/projects/smart-volume-radar/mcp-tv-sync && npm install`
...
Run: `cd ~/.gemini/antigravity/projects/smart-volume-radar/mcp-tv-sync && npm test`
...
Run:
```bash
cd ~/.gemini/antigravity/projects/smart-volume-radar/mcp-tv-sync
printf '%s\n%s\n' \
